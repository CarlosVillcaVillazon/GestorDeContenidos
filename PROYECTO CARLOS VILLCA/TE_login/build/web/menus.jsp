<%-- 
    Document   : menus
    Created on : 01-07-2016, 09:40:58 AM
    Author     : VILLCA
--%>
                ...
                <div class="col-md-8">
                   ...
                   <div class="post-preview">
                       <table border="1">
                           <center>
                    <li>
                        <a class="page-scroll" href="subir.jsp">Gestor de Articulos</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="registro.jsp">Gestor de Registro de Usuario</a>
                    </li>    
                    <li>
                        <a class="page-scroll" href="noticias.jsp">Gestor de Noticias</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="galeria.jsp">Gestor Multimedia</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="Listador">Gestor de Usuarios</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="informacion.jsp">Gestor de información</a>
                    </li>
                    <li>
