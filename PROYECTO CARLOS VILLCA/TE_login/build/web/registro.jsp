<%-- 
    Document   : registro
    Created on : 01-07-2016, 11:31:13 AM
    Author     : VILLCA
--%>
...
<body id="page-top" class="index">
    ...
    <section id="inicio">
        ...
        <form action="Grabador" method="post">
            ...
            <br>
            CEDULA DE IDENTIDAD: <input type="text" name="ci">
            <br>
            REGISTRO UNIVERSITARIO: <input type="text" name="ru">
            <br>
            SEMESTRE: <input type="text" name="semestre">
            <br>
            USUARIO: <input type="text" name="username">
            <br>
            CONTRASEÑA: <input type="text" name="passwords">
            <br>
            <br>
            
            <input type="submit">
            
            <a href=\menus.jsp\>Volver</a>
        </form>
                           </center>
                       </table>
                </div>
