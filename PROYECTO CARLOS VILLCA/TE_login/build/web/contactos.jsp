    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-heading">Sujerencias</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Nuestra Pagina</h2>
                    <h3 class="section-subheading text-muted">Envienos sus inquietudes, nosotros lo atenderemos con mucho gusto. </h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <form name="sentMessage" id="contactForm" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="tel" class="form-control" placeholder="numero telefonico *" id="phone" required data-validation-required-message="Por Favor Ingrese su Numero Telefonico.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
